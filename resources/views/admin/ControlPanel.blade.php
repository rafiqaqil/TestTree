...
<div  align="right" class="container">
    <div class="row">
        ...
        <div class="col-lg-12 pt-2" align="left">
            ...
            <hr>
            <a href="{{env('absolute')}}/MDC/Update/DM3"><button class="btn btn-warning">Update DM3 </button></a>
            <a href="{{env('absolute')}}/MDC/Update/DM5"><button class="btn btn-warning">Update DM5 </button></a>
              <a href="{{env('absolute')}}/MDC/Update/Sponsor"><button class="btn btn-warning">Update Sponsor </button></a>
              <br>
